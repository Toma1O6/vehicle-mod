...
public class ModelProtonP1 extends ModelVehicle<VehicleProtonP1> {
    ...
    public ModelProtonP1() {
        ...
        bone26.setRotationPoint(0.0F, 14.0F, 27.5F);
        ...
        head_lights.setRotationPoint(0.0F, 10.3925F, -27.0036F);
        setRotationAngle(head_lights, -0.8727F, 0.0F, 0.0F);
        head_lights.cubeList.add(new ModelBox(head_lights, 394, 200, 8.0F, -0.8F, 2.5F, 4, 4, 1, 0.0F, false));
        head_lights.cubeList.add(new ModelBox(head_lights, 394, 200, -12.0F, -0.8F, 2.5F, 4, 4, 1, 0.0F, false));

        head_lights_left = new ModelRenderer(this);
        head_lights_left.setRotationPoint(12.5F, 10.5925F, -27.0036F);
        setRotationAngle(head_lights_left, -0.8727F, 0.0F, 0.0F);
        head_lights_left.cubeList.add(new ModelBox(head_lights_left, 440, 250, -0.5F, -0.3F, 2.3F, 1, 3, 1, 0.0F, false));

        head_lights_right = new ModelRenderer(this);
        head_lights_right.setRotationPoint(-12.5F, 10.5925F, -27.0036F);
        setRotationAngle(head_lights_right, -0.8727F, 0.0F, 0.0F);
        head_lights_right.cubeList.add(new ModelBox(head_lights_right, 440, 250, -0.5F, -0.3F, 2.3F, 1, 3, 1, 0.0F, false));

        plate = new ModelRenderer(this);
        plate.setRotationPoint(0.0F, 24.0F, 0.0F);
        plate.cubeList.add(new ModelBox(plate, 392, 210, -2.5F, -7.5F, 34.8F, 6, 2, 1, 0.0F, false));
        ...
        rear_lights_reverse.cubeList.add(new ModelBox(rear_lights_reverse, 413, 218, -9.2F, -11.2F, 33.5F, 1, 2, 1, 0.0F, false));
        rear_lights_reverse.cubeList.add(new ModelBox(rear_lights_reverse, 413, 218, 8.2F, -11.2F, 33.5F, 1, 2, 1, 0.0F, false));

        rear_lights_right = new ModelRenderer(this);
        rear_lights_right.setRotationPoint(0.0F, 24.0F, 0.0F);
        rear_lights_right.cubeList.add(new ModelBox(rear_lights_right, 442, 248, -13.8F, -11.2F, 33.5F, 1, 2, 1, 0.0F, false));

        rear_lights_left = new ModelRenderer(this);
        rear_lights_left.setRotationPoint(0.0F, 24.0F, 0.0F);
        rear_lights_left.cubeList.add(new ModelBox(rear_lights_left, 442, 248, 12.8F, -11.2F, 33.5F, 1, 2, 1, 0.0F, false));
        ...
        registerLightEntries(LightEntry.createLights(1.0F, head_lights, head_lights_right, head_lights_left, plate, rear_lights, rear_lights_reverse,
                rear_lights_right, rear_lights_left, interier));
    }
