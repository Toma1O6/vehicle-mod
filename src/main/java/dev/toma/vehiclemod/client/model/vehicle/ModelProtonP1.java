...
public class ModelProtonP1 extends ModelVehicle {
    ...
    public ModelProtonP1() {
        ...
        bone5.cubeList.add(new ModelBox(bone5, 0, 0, 5.0F, -1.5F, 2.5F, 10, 4, 2, 0.0F, false));
        bone5.cubeList.add(new ModelBox(bone5, 0, 0, -15.0F, -1.5F, 2.5F, 10, 4, 2, 0.0F, false));
        ...
        bone7.cubeList.add(new ModelBox(bone7, 0, 0, 0.0F, -2.9F, -0.1F, 8, 5, 1, 0.0F, false));
        ...
        bone7.cubeList.add(new ModelBox(bone7, 394, 200, 8.0F, -1.6075F, -0.0036F, 4, 4, 1, 0.0F, false));
        bone7.cubeList.add(new ModelBox(bone7, 394, 200, -12.0F, -1.6075F, -0.0036F, 4, 4, 1, 0.0F, false));
        bone7.cubeList.add(new ModelBox(bone7, 440, 250, 12.0F, -0.9075F, -0.0036F, 1, 3, 1, 0.0F, false));
        bone7.cubeList.add(new ModelBox(bone7, 440, 250, -13.0F, -0.9075F, -0.0036F, 1, 3, 1, 0.0F, false));
        ...
        bone7.cubeList.add(new ModelBox(bone7, 0, 0, -8.0F, -2.9F, -0.1F, 8, 5, 1, 0.0F, false));
        ...
        bone22.cubeList.add(new ModelBox(bone22, 26, 21, 0.0F, 2.094F, -0.3342F, 12, 1, 1, 0.0F, false));
        bone22.cubeList.add(new ModelBox(bone22, 26, 21, -12.0F, 2.094F, -0.3342F, 12, 1, 1, 0.0F, false));
        ...
        bone37.cubeList.add(new ModelBox(bone37, 26, 21, -12.0F, -0.2F, -2.1F, 12, 1, 1, 0.0F, false));
        bone37.cubeList.add(new ModelBox(bone37, 26, 21, 0.0F, -0.2F, -2.1F, 12, 1, 1, 0.0F, false));
        ...
        bone46.cubeList.add(new ModelBox(bone46, 40, 24, 0.0F, 3.2F, -3.3F, 15, 2, 8, 0.0F, false));
        ...
        bone49.cubeList.add(new ModelBox(bone49, 0, 0, -8.0F, -0.5F, -1.3F, 8, 2, 2, 0.0F, false));
        bone49.cubeList.add(new ModelBox(bone49, 0, 0, 14.0F, -0.5F, -1.3F, 1, 2, 2, 0.0F, false));
        bone49.cubeList.add(new ModelBox(bone49, 0, 0, 0.0F, -0.5F, -1.3F, 8, 2, 2, 0.0F, false));
        ...
        bone63.cubeList.add(new ModelBox(bone63, 114, 208, 3.0F, -3.2F, -1.0F, 8, 7, 2, 0.0F, false));
        bone63.cubeList.add(new ModelBox(bone63, 114, 208, -11.0F, -3.2F, -1.0F, 8, 7, 2, 0.0F, false));
        ...
        bone67.cubeList.add(new ModelBox(bone67, 26, 21, -0.5F, -0.5F, -2.5F, 1, 1, 5, 0.0F, false));

        bone68 = new ModelRenderer(this);
        bone68.setRotationPoint(-14.5F, 9.5F, -8.5F);
        setRotationAngle(bone68, 0.0F, -0.8727F, 0.8727F);
        bone68.cubeList.add(new ModelBox(bone68, 26, 21, -0.5F, -0.5F, -2.5F, 1, 1, 5, 0.0F, false));
        ...
        bone71.setRotationPoint(-0.5F, 1.2F, 8.8F);
        setRotationAngle(bone71, 0.4363F, 0.0F, 0.0F);
        bone71.cubeList.add(new ModelBox(bone71, 146, 16, -0.5F, -1.5F, -4.6F, 1, 1, 10, 0.0F, false));
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 354, 146, -5.0F, -9.4F, -27.0F, 10, 3, 8, 0.0F, false));
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, 9.0F, -8.0F, 30.1F, 6, 4, 6, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, -15.0F, -8.0F, 30.1F, 3, 4, 6, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, -9.0F, -8.0F, 30.1F, 6, 4, 6, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, 4.0F, -8.0F, 30.1F, 5, 4, 6, 0.0F, false));
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, 12.0F, -19.0F, 20.0F, 1, 5, 1, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, -13.0F, -19.0F, 20.0F, 1, 5, 1, 0.0F, false));
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, -4.0F, -22.3F, -1.7F, 7, 1, 11, 0.0F, false));
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 106, 205, 0.0F, -14.0F, 11.0F, 12, 9, 12, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 106, 205, -12.0F, -14.0F, 11.0F, 12, 9, 12, 0.0F, false));
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 114, 208, -11.0F, -10.9F, 1.0F, 8, 4, 8, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 114, 208, 3.0F, -10.9F, 1.0F, 8, 4, 8, 0.0F, false));
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 442, 248, 12.8F, -11.2F, 33.5F, 1, 2, 1, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 442, 248, -13.8F, -11.2F, 33.5F, 1, 2, 1, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 413, 218, 8.2F, -11.2F, 33.5F, 1, 2, 1, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 413, 218, -9.2F, -11.2F, 33.5F, 1, 2, 1, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 426, 184, 9.5F, -11.2F, 33.5F, 3, 2, 1, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 426, 184, -12.5F, -11.2F, 33.5F, 3, 2, 1, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 202, 16, -3.0F, -8.0F, 27.4F, 7, 3, 8, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 18, 50, -12.0F, -8.0F, 25.1F, 3, 2, 8, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, -15.0F, -7.0F, -30.0F, 3, 3, 2, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, 12.0F, -7.0F, -30.0F, 3, 3, 2, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 232, 34, -4.5F, -10.0F, -27.7F, 1, 3, 6, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 232, 34, -2.5F, -10.0F, -27.7F, 1, 3, 6, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 232, 34, -0.5F, -10.0F, -27.7F, 1, 3, 6, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 232, 34, 1.5F, -10.0F, -27.7F, 1, 3, 6, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 232, 34, 3.5F, -10.0F, -27.7F, 1, 3, 6, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 392, 210, -2.5F, -7.5F, 34.8F, 6, 2, 1, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 202, 16, -12.0F, -7.5F, 30.4F, 3, 3, 3, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 202, 16, -10.4F, -6.5F, 32.4F, 1, 1, 5, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 202, 16, -11.7F, -6.5F, 32.4F, 1, 1, 5, 0.0F, false));
    }
