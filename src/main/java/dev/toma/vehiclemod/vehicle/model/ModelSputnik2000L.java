...
public class ModelSputnik2000L extends ModelVehicle {
    ...
    public ModelSputnik2000L() {
        ...
        bone2.cubeList.add(new ModelBox(bone2, 440, 209, 18.5F, -14.0F, 2.5F, 4, 4, 1, 0.0F, false));
        bone2.cubeList.add(new ModelBox(bone2, 440, 209, -22.5F, -14.0F, 2.5F, 4, 4, 1, 0.0F, false));
        bone2.cubeList.add(new ModelBox(bone2, 444, 248, -22.5F, -9.5F, 2.5F, 4, 1, 1, 0.0F, false));
        bone2.cubeList.add(new ModelBox(bone2, 444, 248, 18.5F, -9.5F, 2.5F, 4, 1, 1, 0.0F, false));
        bone2.cubeList.add(new ModelBox(bone2, 442, 212, 18.5F, -8.0F, 2.5F, 4, 2, 1, 0.0F, false));
        bone2.cubeList.add(new ModelBox(bone2, 392, 199, -22.5F, -8.0F, 2.5F, 4, 2, 1, 0.0F, false));
        bone2.cubeList.add(new ModelBox(bone2, 384, 71, -4.0F, -19.0F, 4.2F, 8, 3, 1, 0.0F, false));
        bone2.cubeList.add(new ModelBox(bone2, 437, 208, -3.5F, -18.5F, 4.5F, 7, 2, 1, 0.0F, false));
        ...
        bone2.cubeList.add(new ModelBox(bone2, 336, 167, -6.5F, -11.0F, 1.5F, 14, 5, 1, 0.0F, false));
        ...
        bone9.cubeList.add(new ModelBox(bone9, 346, 213, -23.5F, -7.0F, -12.9F, 10, 5, 1, 0.0F, false));
        bone9.cubeList.add(new ModelBox(bone9, 346, 213, 13.5F, -7.0F, -12.9F, 10, 5, 1, 0.0F, false));
        bone9.cubeList.add(new ModelBox(bone9, 221, 188, 13.5F, 0.0F, -12.9F, 6, 2, 1, 0.0F, false));
        bone9.cubeList.add(new ModelBox(bone9, 221, 188, -19.5F, 0.0F, -12.9F, 6, 2, 1, 0.0F, false));
        bone9.cubeList.add(new ModelBox(bone9, 442, 251, 20.5F, 0.0F, -12.9F, 3, 2, 1, 0.0F, false));
        bone9.cubeList.add(new ModelBox(bone9, 442, 251, -23.5F, 0.0F, -12.9F, 3, 2, 1, 0.0F, false));
        ...
        bone9.cubeList.add(new ModelBox(bone9, 438, 248, 25.2F, -8.0F, 23.7F, 1, 1, 2, 0.0F, false));
        bone9.cubeList.add(new ModelBox(bone9, 438, 248, -26.3F, -8.0F, 23.7F, 1, 1, 2, 0.0F, false));
        ...
        bone19.cubeList.add(new ModelBox(bone19, 441, 251, 19.0F, 0.5F, 0.3F, 2, 1, 1, 0.0F, false));
        bone19.cubeList.add(new ModelBox(bone19, 180, 221, 19.0F, -3.5F, 0.3F, 2, 1, 1, 0.0F, false));
        bone19.cubeList.add(new ModelBox(bone19, 187, 192, 6.0F, -4.5F, 0.3F, 3, 1, 1, 0.0F, false));
        bone19.cubeList.add(new ModelBox(bone19, 424, 177, 5.0F, -1.5F, 0.3F, 2, 1, 1, 0.0F, false));
        bone19.cubeList.add(new ModelBox(bone19, 237, 211, 5.0F, 0.5F, 0.3F, 2, 1, 1, 0.0F, false));
        bone19.cubeList.add(new ModelBox(bone19, 353, 242, 8.0F, 2.5F, 0.3F, 1, 1, 1, 0.0F, false));
        ...
        bone19.cubeList.add(new ModelBox(bone19, 174, 219, -5.0F, -0.5F, 0.3F, 6, 1, 1, 0.0F, false));
        bone19.cubeList.add(new ModelBox(bone19, 75, 196, -5.0F, -3.5F, 0.3F, 6, 3, 1, 0.0F, false));
