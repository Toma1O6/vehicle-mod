...
import dev.toma.vehiclemod.vehicle.entity.VehicleMCGMultiVan;
import dev.toma.vehiclemod.vehicle.model.ModelMCGMultiVan;
...
public class RenderMCGMultiVan extends RenderVehicle<VehicleMCGMultiVan> {
    ...
    @Override
    public void doRender(VehicleMCGMultiVan entity, double x, double y, double z, float entityYaw, float partialTicks) {
