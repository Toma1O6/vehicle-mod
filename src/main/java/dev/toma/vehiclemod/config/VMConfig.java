...
public class VMConfig {
	...
	@Name("Beamer S120")
	public static VehicleStats beamer_s120 = new VehicleStats(250F, 1.23F, 0.0049F, 0.018F, 0.15F, 3.0F, 0.004f, 50).track();

	@Name("Fedoratti Vulcan")
	public static VehicleStats fedoratti_vulcan = new VehicleStats(220F, 1.74F, 0.007F, 0.023F, 0.25F, 3.5F, 0.0076F, 70).track();

	@Name("Tracer T1")
	public static VehicleStats tracer_t1 = new VehicleStats(250F, 1.52F, 0.0067F, 0.016F, 0.17F, 3.3F, 0.006F, 50).track();
	...
	@Name("Sputnik 3000L")
	public static VehicleStats sputnik3000L = new VehicleStats(250F, 1.4F, 0.0052F, 0.019F, 0.2F, 3.3F, 0.0041F, 50).track();

	@Name("Sputnik 3000L Enforcer")
	public static VehicleStats sputnik3000LEnf = new VehicleStats(300F, 1.58F, 0.0057F, 0.020F, 0.21F, 3.3F, 0.0046F, 50).track();
	...
	@Name("Proton P1")
	public static VehicleStats protonP1 = new VehicleStats(250F, 1.37F, 0.005F, 0.019F, 0.22F, 3.3F, 0.0076F, 50).track();

	@Name("Proton P1 Tunned")
	public static VehicleStats protonP1_tunned = new VehicleStats(220F, 1.4F, 0.0052F, 0.022F, 0.23F, 3.3F, 0.0076F, 50).track();
