...
public class VMConfig {
	...
	public static VehicleStats sputnikAmbulance = new VehicleStats(250F, 1.14F, 0.0042F, 0.016F, 0.14F, 3.0F, 0.009F, 70, new VehicleStats.Vector3i(0, 0, -3)).track();

	@Name("Sputnik Firetruck")
	public static VehicleStats sputnikFiretruck = new VehicleStats(400F, 1.0F, 0.0038F, 0.011F, 0.09F, 2.3F, 0.013F, 100, new VehicleStats.Vector3i(0, 0, -5)).track();
